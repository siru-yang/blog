...
- [ ] 代码格式Eslint插件
- [ ] vue全局变量有什么
- [x] store模式和vuex https://vuex.vuejs.org
- [x] 自定义指令
- [ ] vue 装饰器
- [ ] 调试
- [x] 子组件向父组件传值
...
移动端：原生app，WebAPP H5， Hybird，小程序
...
![image-20211214153308700](C:\Users\yangsiru\AppData\Roaming\Typora\typora-user-images\image-20211214153308700.png)
